...
public class Edit_Citas extends javax.swing.JInternalFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            ...
            ps = conn.prepareStatement("INSERT INTO cita (id_cita, fecha_solicitud, fecha_pautada, falla_carro, observacion, id_vehiculo ) VALUES (?,?,?,?,?,?)");
            ...
            JOptionPane.showMessageDialog(null, "Cita Guardado Exitosamente");
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        try {
            ...
            ps = conn.prepareStatement("UPDATE cita SET id_vehiculo=?, fecha_solicitud=?, fecha_pautada=?, falla_carro=?, observacion=? WHERE id_cita=?");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try {
            ...
            ps = conn.prepareStatement("DELETE FROM cita WHERE id_cita=?");
            ps.setString(1, codigo);
            ps.execute();
