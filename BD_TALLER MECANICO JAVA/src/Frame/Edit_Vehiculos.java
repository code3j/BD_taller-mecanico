...
public class Edit_Vehiculos extends javax.swing.JInternalFrame {

    DefaultTableModel modelo = new DefaultTableModel();

    public Edit_Vehiculos() {
        initComponents();
        ...
        try {
            ...
            String sql = "SELECT id_vehiculo, marca, anio, color, placa, id_propietario FROM vehiculo";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 220, 770, 180));
        ...
        getContentPane().add(txt1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 150, 50, 40));
        ...
        getContentPane().add(txt2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 410, 300, 40));
        ...
        getContentPane().add(txt5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 490, 300, 40));
        ...
        getContentPane().add(txtCampo, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 150, 200, 30));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 30, -1, -1));
        ...
        getContentPane().add(txt4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 230, 120, 40));
        ...
        getContentPane().add(txt6, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 150, 50, 40));
        ...
        getContentPane().add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 150, 80, 30));
    ...
    private void jtProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtProductosMouseClicked
        ...
        try {
            ...
            ps = conn.prepareStatement("SELECT id_vehiculo, marca, anio, color, placa, id_propietario FROM vehiculo WHERE id_vehiculo=?");
            ps.setString(1, codigo);
            rs = ps.executeQuery();

            while (rs.next()) {
                txt1.setText(rs.getString("id_vehiculo"));
                txt2.setText(rs.getString("marca"));
                txt3.setText(rs.getString("anio"));
                txt4.setText(rs.getString("color"));
                txt5.setText(rs.getString("placa"));
                txt6.setText(rs.getString("id_propietario"));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            ...
            ps = conn.prepareStatement("INSERT INTO vehiculo (id_vehiculo, marca, anio, color, placa, id_propietario ) VALUES (?,?,?,?,?,?)");
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        try {
            ...
            ps = conn.prepareStatement("UPDATE vehiculo SET id_propietario=?, marca=?, anio=?, color=?, placa=? WHERE id_vehiculo=?");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try {
            ...
            ps = conn.prepareStatement("DELETE FROM vehiculo WHERE id_vehiculo=?");
            ps.setString(1, codigo);
            ps.execute();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            ...
            String sql = "SELECT id_vehiculo, marca, anio, color, placa, id_propietario FROM vehiculo " + where;
