...
public class Edit_Proveedores extends javax.swing.JInternalFrame {

    DefaultTableModel modelo = new DefaultTableModel();

    public Edit_Proveedores() {
        initComponents();
        ...
        try {
            ...
            String sql = "SELECT id_proveedor, nombre, apellido, empresa, telefono, direccion_empresa FROM proveedor";
            ...
            modelo.addColumn("direccion_empresa");

            int[] anchos = {5, 20, 20, 50, 50, 200};
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 490, 120, 40));
        ...
        jLabel5.setText("ID Proveedores:");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 130, -1, -1));
        ...
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 460, -1, -1));

        txt6.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        getContentPane().add(txt6, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 490, 360, 40));
    ...
    private void jtProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtProductosMouseClicked
        ...
        try {
            ...
            ps = conn.prepareStatement("SELECT id_proveedor, nombre, apellido, empresa, telefono, direccion_empresa FROM proveedor WHERE id_proveedor=?");
            ps.setString(1, codigo);
            rs = ps.executeQuery();

            while (rs.next()) {
                txt1.setText(rs.getString("id_proveedor"));
                txt2.setText(rs.getString("nombre"));
                txt3.setText(rs.getString("apellido"));
                txt4.setText(rs.getString("empresa"));
                txt5.setText(rs.getString("telefono"));
                txt6.setText(rs.getString("direccion_empresa"));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            ...
            ps = conn.prepareStatement("INSERT INTO proveedor (id_proveedor, nombre, apellido, empresa, telefono, direccion_empresa) VALUES (?,?,?,?,?,?)");
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        try {
            ...
            ps = conn.prepareStatement("UPDATE proveedor SET nombre=?, apellido=?, empresa=?, telefono=?, direccion_empresa=? WHERE id_proveedor=?");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try {
            ...
            ps = conn.prepareStatement("DELETE FROM proveedor WHERE id_proveedor=?");
            ps.setString(1, codigo);
            ps.execute();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            ...
            String sql = "SELECT id_proveedor, nombre, apellido, empresa, telefono, direccion_empresa FROM proveedor " + where;
